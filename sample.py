...
st.set_page_config(page_title="EduGenius")

def get_output(question):
    # Call Mistral using Ollama's chat endpoint.
...
def main():
    ...
    if st.button("Generate Question Paper"):
        # Set topics only if the option is 'Topic-wise'
        topics = None if option == 'Full-syllabus' else topics
